...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@sasan8u', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
_👥 Sudoer And Admins Bot Help :_
...
*🔰 /leave *
_🔹 Leave current group_

*🔰 /autoleave* `[disable/enable]`
_🔹 Automatically leaves group_

*🔰 /creategroup* `[text]`
_🔹 Create normal group_

*🔰 /createsuper* `[text]`
_🔹 Create supergroup_

*🔰 /tosuper *
_🔹 Convert to supergroup_

*🔰 /chats*
_🔹 List of added groups_

*🔰 /join* `[id]`
_🔹 Adds you to the group_

*🔰 /rem* `[id]`
_🔹 Remove a group from Database_

*🔰 /import* `[link]`
_🔹 Bot joins via link_

*🔰 /setbotname* `[text]`
_🔹 Change bot's name_

*🔰 /setbotusername* `[text]`
_🔹 Change bot's username_

*🔰 /delbotusername *
_🔹 Delete bot's username_

*🔰 /markread* `[off/on]`
_🔹 Second mark_

*🔰 /broadcast* `[text]`
_🔹 Send message to all added groups_

*🔰 /bc* `[text] [GroupID]`
_🔹 Send message to a specific group_

*🔰 /sendfile* `[folder] [file]`
_🔹 Send file from folder_

*🔰 /sendplug* `[plug]`
_🔹 Send plugin_

*🔰 /save* `[plugin name] [reply]`
_🔹 Save plugin by reply_

*🔰 /savefile* `[address/filename] [reply]`
_🔹 Save File by reply to specific folder_

*🔰 /config*
_🔹 Set Owner and Admin Group_

*🔰 /clear cache*
_🔹 Clear All Cache Of .telegram-cli/data_

*🔰 /check*
_🔹 Stated Expiration Date_

*🔰 /check* `[GroupID]`
_🔹 Stated Expiration Date Of Specific Group_

*🔰 /charge* `[GroupID]` `[Number Of Days]`
_🔹 Set Expire Time For Specific Group_

*🔰 /charge* `[Number Of Days]`
_🔹 Set Expire Time For Group_

*🔰 /jointo* `[GroupID]`
_🔹 Invite You To Specific Group_

*🔰 /leave* `[GroupID]`
_🔹 Leave Bot From Specific Group_

_✅ You can use_ *[!/#]* _at the beginning of commands._

`⚠ ️This help is only for sudoers/bot admins.`
 
*⚠️ This means only the sudoers and its bot admins can use mentioned commands.*
...
text = [[
_👥 راهنمای ادمین و سودو های ربات:_
...
*🔰 /sudolist *
_🔹 لیست سودو‌های ربات_

*🔰 /adminprom* `[username|id|reply]`
_🔹 اضافه کردن ادمین به ربات_

*🔰 /admindem* `[username|id|reply]`
_🔹 حذف فرد از ادمینی ربات_

*🔰 /adminlist *
_🔹 لیست ادمین ها_

*🔰 /leave *
_🔹 خارج شدن ربات از گروه_
...
*🔰 /chats*
_🔹 لیست گروه های مدیریتی ربات_

*🔰 /join* `[ID]`
_🔹 جوین شدن توسط ربات_

*🔰 /rem* `[GroupID]`
_🔹 حذف گروه ازطریق پنل مدیریتی_

*🔰 /import* `[link]`
_🔹 جوین شدن ربات توسط لینک_

*🔰 /setbotname* `[text]`
_🔹 تغییر اسم ربات_

*🔰 /setbotusername* `[text]`
_🔹 تغییر یوزرنیم ربات_

*🔰 /delbotusername* 
_🔹 پاک کردن یوزرنیم ربات_

*🔰 /markread* `[on/off]`
_🔹 تیک دوم_

*🔰 /broadcast* `[text]`
_🔹 فرستادن پیام به تمام گروه های مدیریتی ربات_

*🔰 /bc* `[text]` `[GroupID]`
_🔹 ارسال پیام مورد نظر به گروه خاص_

*🔰 /sendfile* `[cd]` `[file]`
_🔹 ارسال فایل موردنظر از پوشه خاص_

*🔰 /sendplug* `[plugname]`
_🔹 ارسال پلاگ مورد نظر_

*🔰 /save* `[plugname] [reply]`
_🔹 ذخیره کردن پلاگین_

*🔰 /savefile* `[address/filename] [reply]`
_🔹 ذخیره کردن فایل در پوشه مورد نظر_

*🔰 /config*
_🔹 اضافه کردن سازنده و مدیران گروه به مدیریت ربات_

*🔰 /clear cache*
_🔹 پاک کردن کش مسیر .telegram-cli/data_

*🔰 /check*
_🔹 اعلام تاریخ انقضای گروه_

*🔰 /check* `[GroupID]`
_🔹 اعلام تاریخ انقضای گروه مورد نظر_

*🔰 /charge* `[GroupID]` `[days]`
_🔹 تنظیم تاریخ انقضای گروه مورد نظر_

*🔰 /charge* `[days]`
_🔹 تنظیم تاریخ انقضای گروه_

*🔰 /jointo* `[GroupID]`
_🔹 دعوت شدن شما توسط ربات به گروه مورد نظر_

*🔰 /leave* `[GroupID]`
_🔹 خارج شدن ربات از گروه مورد نظر_

*✅ شما میتوانید از [!/#] در اول دستورات برای اجرای آنها بهره بگیرید*

_⚠️ این راهنما فقط برای سودو ها/ادمین های ربات میباشد!_

`⚠️ این به این معناست که فقط سودو ها/ادمین های ربات میتوانند از دستورات بالا استفاده کنند!`
...
*🔰 پیکربندی*
_🔹 Set Owner and Admin Group as Moderator_
...
`⚠️ This help is only for sudoers/bot admins.`
