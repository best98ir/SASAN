...
_▪️ Set Group Owner(Multi Owner)_

*🔰 /remowner* `[username|id|reply]` 
 _▪️ Remove User From Owner List_

*🔰 /promote* `[username|id|reply]` 
_▪️ Promote User To Group Admin_

*🔰 /demote* `[username|id|reply]` 
_▪️ Demote User From Group Admins List_

*🔰 /setflood* `[1-50]`
_▪️ Set Flooding Number_

*🔰 /setchar* `[Number]`
_▪️ Set Flooding Characters_

*🔰 /setfloodtime* `[1-10]`
_▪️ Set Flooding Time_

*🔰 /silent* `[username|id|reply]` 
_▪️ Silent User From Group_

*🔰 /unsilent* `[username|id|reply]` 
_▪️ Unsilent User From Group_

*🔰 /kick* `[username|id|reply]` 
_▪️ Kick User From Group_

*🔰 /ban* `[username|id|reply]` 
_▪️ Ban User From Group_

*🔰 /unban* `[username|id|reply]` 
_▪️ UnBan User From Group_

*🔰 /whitelist* [+-] `[username|id|reply]` 
_▪️ Add Or Remove User From White List_
...
*🔰 /pin* `[reply]`
_▪️ Pin Your Message_

*🔰 /unpin* 
_▪️ Unpin Pinned Message_

*🔰 /welcome enable/disable*
_▪️ Enable Or Disable Group Welcome_

*🔰 /settings*
_▪️ Show Group Settings_

*🔰 /mutelist*
_▪️ Show Mutes List_

*🔰 /silentlist*
_▪️ Show Silented Users List_

*🔰 /filterlist*
_▪️ Show Filtered Words List_

*🔰 /banlist*
_▪️ Show Banned Users List_

*🔰 /ownerlist*
_▪️ Show Group Owners List_ 

*🔰 /modlist* 
_▪️ Show Group Moderators List_

*🔰 /whitelist* 
_▪️ Show Group White List Users_

*🔰 /rules*
_▪️ Show Group Rules_

*🔰 /about*
_▪️ Show Group Description_

*🔰 /id*
_▪️ Show Your And Chat ID_

*🔰 /gpinfo*
_▪️ Show Group Information_

*🔰 /newlink*
_▪️ Create A New Link_

*🔰 /link*
_▪️ Show Group Link_

*🔰 /linkpv*
_▪️ Send Group Link In Your Private Message_

*🔰 /setwelcome [text]*
_▪️ set Welcome Message_

*🔰 /setlang [fa | en]*
_▪️ Set Persian/English Language_

*🔰 /setcmd [fa | en]*
_▪️ Set CMD Persian/English Language_

*🔰 /helptools*
_▪️ Show Tools Help_

*🔰 /helpfun*
_▪️ Show Fun Help_

_✅ You Can Use_ *[!/#]* _To Run The Commands_
_⚠️ This Help List Only For_ *Moderators/Owners!*
_⚠️ Its Means, Only Group_ *Moderators/Owners* _Can Use It!_
...
*🔰 /setowner* `[username|id|reply]`
_▪️ انتخاب مالک گروه(قابل انتخاب چند مالک)_

*🔰 /remowner* `[username|id|reply]`
_▪️ حذف کردن فرد از فهرست مالکان گروه_

*🔰 /promote* `[username|id|reply]`
_▪️ ارتقا مقام کاربر به مدیر گروه_

*🔰 /demote* `[username|id|reply]`
_▪️ تنزیل مقام مدیر به کاربر_

*🔰 /setflood* `[1-50]`
_▪️ تنظیم حداکثر تعداد پیام مکرر_

*🔰 /setchar* `[Number]`
_▪️ تنظیم حداکثر کاراکتر پیام مکرر_

*🔰 /setfloodtime* `[1-10]`
_▪️ تنظیم زمان ارسال پیام مکرر_

*🔰 /silent* `[username|id|reply]`
_▪️ بیصدا کردن کاربر در گروه_

*🔰 /unsilent* `[username|id|reply]`
_▪️ در آوردن کاربر از حالت بیصدا در گروه_

*🔰 /kick* `[username|id|reply]`
_▪️ حذف کاربر از گروه_

*🔰 /ban* `[username|id|reply]`
_▪️ مسدود کردن کاربر از گروه_

*🔰 /unban* `[username|id|reply]`
_▪️ در آوردن از حالت مسدودیت کاربر از گروه_

*🔰 /whitelist* `[+|-]` `[یوزرنیم|ایدی|ریپلی]` 
_▪️ افزودن افراد به لیست سفید_

*🔰 /res* `[username]`
_▪️ نمایش شناسه کاربر_

*🔰 /id* `[reply]`
_▪️ نمایش شناسه کاربر_

*🔰 /whois* `[id]`
_▪️ نمایش نام کاربر, نام کاربری و اطلاعات حساب_

*🔰 /lock* `[link | tag | edit | arabic | webpage | bots | spam | flood | markdown | mention | pin]`
_▪️ در صورت قفل بودن فعالیت ها, ربات آنهارا حذف خواهد کرد_

*🔰 /unlock* `[link | tag | edit | arabic | webpage | bots | spam | flood | markdown | mention | pin]`
_▪️ در صورت قفل نبودن فعالیت ها, ربات آنهارا حذف نخواهد کرد_

*🔰 /mute* `[gif | photo | document | sticker | keyboard | video | text | forward | location | audio | voice | contact | all]`
_▪️ در صورت بیصدد بودن فعالیت ها, ربات آنهارا حذف خواهد کرد_

*🔰 /unmute* `[gif | photo | document | sticker | keyboard | video | text | forward | location | audio | voice | contact | all]`
_▪️ در صورت بیصدا نبودن فعالیت ها, ربات آنهارا حذف نخواهد کرد_

*🔰 /set*`[rules | name | photo | link | about | welcome]`
_▪️ ربات آنهارا ثبت خواهد کرد_

*🔰 /clean* `[bans | mods | rules | about | silentlist | filterlist | welcome]`
_▪️ ربات آنهارا پاک خواهد کرد_

*🔰 /filter* `[word]`
_▪️ فیلتر‌کلمه مورد نظر_

*🔰 /unfilter* `[word]`
_▪️ ازاد کردن کلمه مورد نظر_

*🔰 /pin* `[reply]`
_▪️ ربات پیام شمارا در گروه سنجاق خواهد کرد_

*🔰 /unpin *
_▪️ ربات پیام سنجاق شده در گروه را حذف خواهد کرد_

*🔰 /welcome* `enable/disable`
_▪️ فعال یا غیرفعال کردن خوشامد گویی_

*🔰 /settings*
_▪️ نمایش تنظیمات گروه_

*🔰 /mutelist*
_▪️ نمایش فهرست بیصدا های گروه_

*🔰 /silentlist*
_▪️ نمایش فهرست افراد بیصدا_

*🔰 /filterlist*
_▪️ نمایش لیست کلمات فیلتر شده_

*🔰 /banlist*
_▪️ نمایش افراد مسدود شده از گروه_

*🔰 /ownerlist*
_▪️ نمایش فهرست مالکان گروه_

*🔰 /modlist*
_▪️ نمایش فهرست مدیران گروه_

*🔰 /whitelist*
_▪️ نمایش افراد سفید شده از گروه_

*🔰 /rules*
_▪️ نمایش قوانین گروه_

*🔰 /about*
_▪️ نمایش درباره گروه_

*🔰 /id*
_▪️ نمایش شناسه شما و گروه_

*🔰 /gpinfo*
_▪️ نمایش اطلاعات گروه_

*🔰 /newlink*
_▪️ ساخت لینک جدید_

*🔰 /setlink*
_▪️ تنظیم لینک جدید_

*🔰 /link*
_▪️ نمایش لینک گروه_

*🔰 /linkpv*
_▪️ ارسال لینک گروه به چت خصوصی شما_

*🔰 /setwelcome* `[text]`
_▪️ ثبت پیام خوش آمد گویی_

*🔰 /setlang* `[fa | en]`
_▪️ تنظیم زبان ربات به فارسی یا انگلیسی_

*🔰 /setcmd* `[fa | en]`
_▪️ تنظیم زبان دستورات ربات به فارسی یا انگلیسی_

*🔰 /helptools*
_▪️ نمایش راهنمای ابزار_

*🔰 /helpfun*
_▪️ نمایش راهنمای سرگرمی_

_✅ شما میتوانید از [!/#] در اول دستورات برای اجرای آنها بهره بگیرید_

_⚠️ این راهنما فقط برای مدیران/مالکان گروه میباشد!_

_⚠️ این به این معناست که فقط مدیران/مالکان گروه میتوانند از دستورات بالا استفاده کنند!_
...
*🔰 بیصدا* `[همه | تصاویر متحرک | عکس | اسناد | برچسب | صفحه کلید | فیلم | متن | نقل قول | موقعیت | اهنگ | صدا | مخاطب | کیبورد شیشه ای|بازی|خدمات تلگرام]`
_▪️ در صورت بیصدا بودن فعالیت ها, ربات آنهارا حذف خواهد کرد_
...
*🔰 تنظیم لینک*
_▪️ تنظیم لینک جدید برای گروه_

*🔰 لینک خصوصی*
_▪️ ارسال لینک گروه به چت خصوصی شما_

*🔰 زبان انگلیسی*
_▪️ تنظیم زبان انگلیسی_

*🔰 زبان فارسی*
_▪️ تنظیم زبان فارسی_

*🔰 دستورات انگلیسی*
_▪️ تنظیم دستورات انگلیسی_

*🔰 دستورات فارسی*
_▪️ تنظیم دستورات فارسی_
